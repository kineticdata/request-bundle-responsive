            ...
            %>
                <% 
                    ...
                    if(!iterator.hasNext()) {
                        ...
                        href= "<a href='"+ bundle.getProperty("catalogUrl")+ "&view=category&category=" + URLEncoder.encode(category.getFullName(), "UTF-8") +"' alt='" + category.getName() + "'>" + themeLocalizer.getString(category.getName()) + "</a>";    
                    }
                %>
